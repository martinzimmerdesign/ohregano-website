...
export default function Button({ title, link, color }) {
  ...
  return (
    <Link href={"/" + link}>
      ...
      <motion.div variants={variants.basic} className=" disable_select">
        <div style={{backgroundColor: color == undefined ? "var(--color-main)" : color.toString() }} className={styles.container}>
